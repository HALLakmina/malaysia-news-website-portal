    ...
    <div>
      <h1 className="text-center my-8 text-4xl sm:text-5xl font-bold">NEWS PANEL</h1>
        ...
        <div className="flex flex-row items-center justify-between my-5">
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add NEWS +</button>
            ...
            <tr className="w-full block sm:table-row odd:bg-white even:bg-gray-50 border-b dark:border-gray-700">
              ...
              <td data-label="ACTION" className="w-full table-data-header block sm:table-cell px-4 py-4">
                <div className='flex flex-col md:flex-row'>
                  ...
                  <button type="button"className="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Disable</button>
